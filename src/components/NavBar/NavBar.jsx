        ...
        return (
            ...
            // </nav>
                ...
                >
                    <a
                    href="#"
                    class="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center hover:bg-rose-600 hover:text-white"
                    >
                    <Link to="/home" className="">Main Page  </Link>
                    </a>
                    <a
